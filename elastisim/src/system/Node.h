...
private:
	...
	// Shutdown policy support
	double stateTransitionTime = -1.0;
	NodeState targetState = NODE_FREE;
...
public:
	...
	void scheduleTransition(NodeState target, int delaySeconds);
	void checkScheduledTransition(double currentTime);
